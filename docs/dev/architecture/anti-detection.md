...
为避免完整体系继续散落在架构描述中，GitHub issue 层当前以 `Phase -> FR -> Work Item` 作为唯一主树：

| 层级 | GitHub 当前 canonical 挂接 |
| --- | --- |
| `Phase 1.x` | `#426 -> #215/#230/#231/#435` |
| `Phase 2` | `#427 -> #265/#267/#266/#418/#420/#419/#239/#153` |
| `Phase 4` | `#423 -> #238` |
